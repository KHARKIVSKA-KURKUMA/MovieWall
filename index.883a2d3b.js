 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Si extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}const Ti=function(e){return function(e){const t=Ei(e);return ki.encodeByteArray(t,!0)}(e).replace(/\./g,"")},Ci=function(e){try{return ki.decodeString(e,!0)}catch(e){console.error("base64Decode failed: ",e)}return null};
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Vr;Vr="",Or(new Yi("platform-logger",(e=>new kr(e)),"PRIVATE")),Or(new Yi("heartbeat",(e=>new Hr(e)),"PRIVATE")),Dr("@firebase/app","0.9.7",Vr),Dr("@firebase/app","0.9.7","esm2017"),Dr("fire-js","");
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bo(e,t){return e.tenantId&&!t.tenantId?Object.assign(Object.assign({},t),{tenantId:e.tenantId}):t}async function wo(e,t,n,i,r={}){return _o(e,r,(async()=>{let r={},o={};i&&("GET"===t?o=i:r={body:JSON.stringify(i)});const s=qi(Object.assign({key:e.config.apiKey},o)).slice(1),a=await e._getAdditionalHeaders();return a["Content-Type"]="application/json",e.languageCode&&(a["X-Firebase-Locale"]=e.languageCode),go.fetch()(xo(e,e.config.apiHost,n,s),Object.assign({method:t,headers:a,referrerPolicy:"no-referrer"},r))}))}async function _o(e,t,n){e._canInitEmulator=!1;const i=Object.assign(Object.assign({},yo),t);try{const t=new Eo(e),r=await Promise.race([n(),t.promise]);t.clearNetworkTimeout();const o=await r.json();if("needConfirmation"in o)throw ko(e,"account-exists-with-different-credential",o);if(r.ok&&!("errorMessage"in o))return o;{const t=r.ok?o.errorMessage:o.error.message,[n,s]=t.split(" : ");if("FEDERATED_USER_ID_ALREADY_LINKED"===n)throw ko(e,"credential-already-in-use",o);if("EMAIL_EXISTS"===n)throw ko(e,"email-already-in-use",o);if("USER_DISABLED"===n)throw ko(e,"user-disabled",o);const a=i[n]||n.toLowerCase().replace(/[_\s]+/g,"-");if(s)throw to(e,a,s);Zr(e,a)}}catch(t){if(t instanceof Ui)throw t;Zr(e,"network-request-failed",{message:String(t)})}}async function Io(e,t,n,i,r={}){const o=await wo(e,t,n,i,r);return"mfaPendingCredential"in o&&Zr(e,"multi-factor-auth-required",{_serverResponse:o}),o}function xo(e,t,n,i){const r=`${t}${n}?${i}`;return e.config.emulator?mo(e.config,r):`${e.config.apiScheme}://${r}`}class Eo{constructor(e){this.auth=e,this.timer=null,this.promise=new Promise(((e,t)=>{this.timer=setTimeout((()=>t(eo(this.auth,"network-request-failed"))),vo.get())}))}clearNetworkTimeout(){clearTimeout(this.timer)}}function ko(e,t,n){const i={appName:e.name};n.email&&(i.email=n.email),n.phoneNumber&&(i.phoneNumber=n.phoneNumber);const r=eo(e,t,i);return r.customData._tokenResponse=n,r}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ks(e,t,n=!1){const i=await No(e,t._linkToIdToken(e.auth,await e.getIdToken()),n);return _s._forOperation(e,"link",i)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ea=new po(5e3,15e3),ka={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},Sa=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function Ta(e){const t=e.config;ro(t.authDomain,e,"auth-domain-config-required");const n=t.emulator?mo(t,"emulator/auth/iframe"):`https://${e.config.authDomain}/__/auth/iframe`,i={apiKey:t.apiKey,appName:e.name,v:"9.19.1"},r=Sa.get(e.config.apiHost);r&&(i.eid=r);const o=e._getFrameworks();return o.length&&(i.fw=o.join(",")),`${n}?${qi(i).slice(1)}`}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
